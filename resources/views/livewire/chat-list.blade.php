<div wire:poll.2s class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex justify-between items-baseline mb-1">
                                <h3 class="text-base font-bold text-gray-900 truncate">
                                    ...
                                    <span class="text-xs font-normal text-gray-500 ml-2">({{ $isSeller ? 'Pembeli' : 'Penjual' }})</span>
                                </h3>
                                @if($lastMessage)
