    ...
    <div class="space-y-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-1">Welcome back, {{ auth()->user()->username }}. Here's how your shop is doing.
                </p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            @if ($products->isEmpty())
                <div class="p-12 text-center">
                    ...
                    <a href="{{ route('products.create') }}"
                        class="text-crave-green font-semibold hover:text-crave-darkgreen">Add your first product &rarr;</a>
                </div>
            @else
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($product->status == 'available')
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700">Available</span>
                                        @elseif($product->status == 'sold_out')
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-700">Sold
                                                Out</span>
                                        @else
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">Expired</span>
                                        @endif
                                    </td>
