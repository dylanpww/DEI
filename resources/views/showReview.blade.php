...
<div class="max-w-2xl mx-auto px-4 py-12">
    <!-- Tombol Back -->
    <a href="{{ route('my-transactions') }}" class="flex items-center gap-2 text-gray-400 hover:text-crave-teal transition-colors mb-8 group">
    ...
    <div class="bg-white rounded-[3rem] shadow-sm border border-gray-100 overflow-hidden p-8 md:p-12">
        <div class="text-center mb-8">
            <span class="bg-crave-lime/20 text-crave-darkgreen px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest">Your Review</span>
        ...
        <div class="flex items-center gap-4 p-5 bg-gray-50 rounded-3xl mb-8 border border-gray-100">
            <div class="w-16 h-16 bg-crave-beige rounded-2xl overflow-hidden flex-shrink-0">
                <img src="{{ asset('storage/'.$review->product->image) }}" class="w-full h-full object-cover" onerror="this.src='https://placehold.co/100x100?text=Food'">
            </div>
            <div>
