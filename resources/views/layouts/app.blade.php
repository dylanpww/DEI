                ...
                <div class="flex justify-between items-center h-20">
                    ...
                    <nav class="hidden md:flex space-x-10 text-gray-600 font-medium text-lg">
                        <a href="{{ route('explore') }}"
                            class="{{ request()->is('explore') ? 'text-crave-darkgreen border-b-2 border-crave-lime' : 'hover:text-crave-lime' }} transition-colors pb-1">Explore</a>
                        <a href="{{ route('cart') }}"
                            class="{{ request()->is('cart') ? 'text-crave-darkgreen border-b-2 border-crave-lime' : 'hover:text-crave-lime' }} transition-colors pb-1 flex items-center">Cart
                            @php
                            ...
                            @if ($totalQty > 0)
                                <span
                                    class="ml-2 bg-crave-pink text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                                    {{ $totalQty }}
                                </span>
                            @endif
                        </a>
